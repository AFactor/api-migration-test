...
var resultFileName = './results' + new Date() +'.txt'
...
var getHeaders = {
  ...
  var dedicatedConsumerUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/consumerApps";
			...
			request.get({
		    	...
		    	if(body1){
		    		...
		    		//dedicatedConsumerApps.splice(dedicatedConsumerApps.length-1, 1);
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "Live: No change in consumer apps", "Live: change in consumer apps", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedregistryUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/registries/55ed50710cf2554a85f86d41";
		    	...
		    	if(body1){
		    		...
		    		//dedicatedRegistry.name = "DingDong";
		    		 var change = jsonDiff.diff(publicRegistry, dedicatedRegistry);
   					 writeChangeToFile(JSON.stringify(change), "Live: No change in registry", "Live: change in registry", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedSubUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/subscriptions";
			...
			request.get({
		    	...
		    	if(body1){
		    		dedicatedSubApps = JSON.parse(body1);
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "Live: No change in Subscription", "Live: change in Subscription", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedPrdUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/products?expand=true";
			...
			request.get({
		    	...
		    	if(body1){
		    		dedicatedPrdApps = JSON.parse(body1);
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "Live: No change in Products", "Live: change in Products", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedMemUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/members";
		    	...
		    	if(body1){
		    		...
		    		publicMemApps.sort(function(a, b) {
 					...
 					"Public Live members extracted at " + new Date().toString() + " and saved in Results subfolder");
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "Live: No change in Members", "Live: change in Members", resultFileName)
		    	}
		    });
    	}
    });
 // ConsumerOrgs
  ...
  var dedicatedConsumerOrgsUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/consumerOrgs";
			...
			request.get({
		    	...
		    	if(body1){
		    		...
		    		writeDataToFile(publicOrgApps, util.format(fileLocation, "publicLiveConsumerOrgs"),
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "Live: No change in consumer Orgs", "Live: change in consumer orgs", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedEnvUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments";
		    	...
		    	if(body1){
		    		...
		    		publicEnvApps.sort(function(a, b) {
		    		 ...
		    		 writeDataToFile(publicEnvApps, util.format(fileLocation, "publicCommonEnvs"),
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "Common: No change in Enviornments", "Common: change in Enviornments", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedDPrdUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/products";
		    	...
		    	if(body1){
		    		...
		    		publicDPrdApps.sort(function(a, b) {
		    		 ...
		    		 writeDataToFile(publicDPrdApps, util.format(fileLocation, "publicCommonDraftProducts"),
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "Common: No change in Draft Products", "Common: change in Draft Products", resultFileName)
		    	}
		    });
    	}
    });
...
//---------------------UAT ---------------------------------------------
  ...
  var dedicatedUATConsumerUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/consumerApps";
			...
			request.get({
		    	...
		    	if(body1){
		    		...
		    		//dedicatedConsumerApps.splice(dedicatedConsumerApps.length-1, 1);
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "UAT: No change in consumer apps", "UAT: change in consumer apps", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedUATregistryUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/registries/55ed50710cf2554a85f86d41";
		    	...
		    	if(body1){
		    		...
		    		//dedicatedRegistry.name = "DingDong";
		    		 var change = jsonDiff.diff(publicUATRegistry, dedicatedUATRegistry);
   					 writeChangeToFile(JSON.stringify(change), "UAT: No change in registry", "UAT: change in registry", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedUATSubUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/subscriptions";
			...
			request.get({
		    	...
		    	if(body1){
		    		dedicatedUATSubApps = JSON.parse(body1);
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "UAT: No change in Subscription", "UAT: change in Subscription", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedUATPrdUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/products?expand=true";
			...
			request.get({
		    	...
		    	if(body1){
		    		dedicatedUATPrdApps = JSON.parse(body1);
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "UAT: No change in Products", "UAT: change in Products", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedUATMemUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/members";
		    	...
		    	if(body1){
		    		...
		    		publicUATMemApps.sort(function(a, b) {
 					...
 					"Public UAT members extracted at " + new Date().toString() + " and saved in Results subfolder");
   					 var change = filter(publicMemApps, dedicatedMemApps);
   					 writeChangeToFile(JSON.stringify(change), "UAT: No change in Members", "UAT: change in Members", resultFileName)
		    	}
		    });
    	}
    });
 // ConsumerOrgs
  ...
  var dedicatedUATConsumerOrgsUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55f16d010cf2fae1b6b74fec/consumerOrgs";
			...
			request.get({
		    	...
		    	if(body1){
		    		...
		    		writeDataToFile(publicUATOrgApps, util.format(fileLocation, "publicUATConsumerOrgs"),
		    			"Public UAT consumer Orgs  extracted at " + new Date().toString() + " and saved in Results subfolder");
   					 var change = filter(publicOrgApps, dedicatedOrgApps);
   					 writeChangeToFile(JSON.stringify(change), "UAT: No change in consumer Orgs", "UAT: change in consumer orgs", resultFileName)
		    	}
		    });
    	}
    });
...
//---------------------DEV ---------------------------------------------
  ...
  var dedicatedDEVConsumerUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55eeff8d0cf2822d3faa322e/consumerApps";
  ...
  var dedicatedDEVregistryUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/registries/55eeff8d0cf2822d3faa322e";
		    	...
		    	if(body1){
		    		...
		    		//dedicatedRegistry.name = "DingDong";
		    		 var change = jsonDiff.diff(publicDEVRegistry, dedicatedDEVRegistry);
   					 writeChangeToFile(JSON.stringify(change), "DEV: No change in registry", "DEV: change in registry", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedDEVSubUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55eeff8d0cf2822d3faa322e/subscriptions";
			...
			request.get({
		    	...
		    	if(body1){
		    		dedicatedDEVSubApps = JSON.parse(body1);
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "DEV: No change in Subscription", "DEV: change in Subscription", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedDEVPrdUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55eeff8d0cf2822d3faa322e/products?expand=true";
			...
			request.get({
		    	...
		    	if(body1){
		    		dedicatedDEVPrdApps = JSON.parse(body1);
   					 ...
   					 writeChangeToFile(JSON.stringify(change), "DEV: No change in Products", "DEV: change in Products", resultFileName)
		    	}
		    });
    	}
    });
  ...
  var dedicatedDEVMemUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55eeff8d0cf2822d3faa322e/members";
		    	...
		    	if(body1){
		    		...
		    		publicDEVMemApps.sort(function(a, b) {
 					...
 					"Public DEV members extracted at " + new Date().toString() + " and saved in Results subfolder");
   					 var change = filter(publicMemApps, dedicatedMemApps);
   					 writeChangeToFile(JSON.stringify(change), "DEV: No change in Members", "DEV: change in Members", resultFileName)
		    	}
		    });
    	}
    });
 // ConsumerOrgs
  ...
  var dedicatedDEVConsumerOrgsUrl = "https://eu.apiconnect.ibmcloud.com/v1/orgs/55a900b10cf272a4b3015a7a/environments/55eeff8d0cf2822d3faa322e/consumerOrgs";
			...
			request.get({
		    	...
		    	if(body1){
		    		...
		    		writeDataToFile(publicDEVOrgApps, util.format(fileLocation, "publicDEVConsumerOrgs"),
		    			"Public DEV consumer Orgs  extracted at " + new Date().toString() + " and saved in Results subfolder");
   					 var change = filter(publicOrgApps, dedicatedOrgApps);
   					 writeChangeToFile(JSON.stringify(change), "DEV: No change in consumer Orgs", "DEV: change in consumer orgs", resultFileName)
		    	}
		    });
    	}
    });
  ...
  //--------------------DEV END -------------------
   ...
   var writeChangeToFile = function(change, noChangeText, changeText, path){
   		if(change){
   			change = util.format('\n-----%s------\n %s', changeText, change);
			fs.appendFile(path, change, function(err) {
			if(err) {
   ...
   function filter(obj1, obj2) {
    ...
    for(var key in obj1) {
        ...
        if(obj2[key] != obj1[key]) {
          if(obj2[key] != 'undefined' || obj2[key] != 'undefined'){
