...
namespace IBMApiAnalytics.Client
{
    public class AnalyticsElasticClient
    {
        ...
        public IBulkResponse IndexSummaryWithOrg(IEnumerable<CallSummaryForOrg> data, string server)
        {
            ...
            var response = IndexManyInElastic(server, indexName, data);
        ...
        public IBulkResponse IndexDetail(IEnumerable<Call> data, DateTime date, string server)
        {
            ...
            var dataLit = (data.Select(d => new CallLit
                                        { Id = d.Id, apiName = d.apiName, datetime = d.datetime, devOrgName = d.devOrgName, productName = d.productName,
                                            statusCode = d.statusCode, timeToServeRequest = d.timeToServeRequest, payload = d.requestBody }));
        ...
        private static IBulkResponse IndexManyInElastic<T>(string server, string indexName, IEnumerable<T> objectsToBeIndexed) where T : class
        {
